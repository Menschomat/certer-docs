---
title: "Audit Reports"
description: "Generate static audit reports from the Certer CLI."
icon: "monitoring"
weight: 20
aliases:
  - /docs/api/audit-report/
---
...
The HTML report is a standalone file with embedded CSS, Certer branding, and a local light/dark/system theme toggle. It uses `GET /api/v1/certificates/status`, so it only transfers certificate health metadata and does not download certificate PEM bodies or private keys.
